...
namespace GammaLibrary.Extensions
{
    ...
    {
        private static readonly ThreadLocal<MD5> _md5 = new ThreadLocal<MD5>();
        ...
        private static readonly ThreadLocal<SHA256> _sha256 = new ThreadLocal<SHA256>();
        ...
        private static readonly ThreadLocal<SHA1> _sha1 = new ThreadLocal<SHA1>();
        ...
        private static readonly ThreadLocal<SHA512> _sha512 = new ThreadLocal<SHA512>();
